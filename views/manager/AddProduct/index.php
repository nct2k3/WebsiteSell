...
<body class=" ">
    <h1 class="text-2xl font-bold mt-2 text-center ">Add new products</h1>
    <div class="max-w-6xl mx-auto px-6 py-4 bg-white rounded-lg shadow-md mt-10">
        <div class="grid  md:grid-cols-3 gap-4">
             <div>
                ...
                <form method="POST" action="?controller=Addproduct" enctype="multipart/form-data">
            ...
            <form action="?controller=Addproduct" method="POST" class="grid  md:grid-cols-3 gap-4">
